...
namespace GenshinImpactGuider.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = GenshinImpactGuiderConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(GenshinImpactGuiderDbContext context)
        {
            _context = context;
        }
