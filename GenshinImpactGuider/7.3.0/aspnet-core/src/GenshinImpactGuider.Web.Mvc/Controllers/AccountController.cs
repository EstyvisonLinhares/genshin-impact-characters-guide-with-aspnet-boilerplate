...
using GenshinImpactGuider.Sessions;
using GenshinImpactGuider.Web.Models.Account;
using GenshinImpactGuider.Web.Views.Shared.Components.TenantChange;

namespace GenshinImpactGuider.Web.Controllers
{
    public class AccountController : GenshinImpactGuiderControllerBase
    {
